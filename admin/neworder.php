...
<body>
    ...
    <div class="container text-center small">
                ...
                <div class="card-body">
                    <form class="row g-3" id="customerdetail">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputmobile" name="mobile" required minlength="10" maxlength="10">
                        </div>
                        <div class="col-12">
        ...
        <!-- product table -->
        <div class="shadow border-4">
            <div class="card my-4 shadow text-center">
                <div class="card-header">
                    <h1>Products</h1>
                </div>
            </div>
...
<script>
    ...
    function getproducttable() {
        ...
        xhttp.open("GET", "list.php?list=allproduct", true);
        xhttp.send();
    }
    ...
    function placeorder() {
        ...
        let data = "products=" + JSON.stringify(products) + "&name=" + custdetail.get('name') + "&mobile=" + custdetail.get(
            ...
            custdetail.get('city') + "&state=" + custdetail.get('state');
