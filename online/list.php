...
if ($_GET['list'] == 'product') {
    ...
    while ($product = mysqli_fetch_assoc($result)) {
        ...
        echo
        '<div class="col p-1">
            <div class="card  border border-3 rounded-2 shadow p-0 mb-4 bg-white w-90">
                ...
                <img src="images/' . $image . '" class="card-img-top" alt="..." width=100% height="150">
                ...
                <div class="card-body d-flex justify-content-center flex-column p-2">
                    ...
                    <hr>
                    <h4><small style="font-size: small">MRP : <s class="text-danger">' . $mrp . 'Rs. </s></small><strong class="text-success"> ' . $price . 'Rs. </strong></h4>
                </div>
                ...
                <div class="card-footer">
                    ...
                    <div class="p-1">
                        <button type="button" class="btn btn-primary p-1" onclick=addproduct(this) ';
                        if ($available == '0') {
                            echo 'disabled';
                        }
                        echo '><img src="images/cart.png" alt="." width="30" height="30"><small>  Add to cart</small></button>
                    </div>
                </div>
            </div>
        </div>';
