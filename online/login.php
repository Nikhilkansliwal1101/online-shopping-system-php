...
<body>
    ...
    <div class="container border border-4 shadow p-3" style="max-width: 600px">
        ...
        <!-- modal for otp enter -->
        <div class="modal fade" id="otpmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1"
            aria-hidden="true">
        ...
        <div class="modal fade" id="passmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form method="post" action="login.php" onsubmit="checksamepassword(event)">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="rnewpassword" name="rnewpassword"
                                    required>
                            </div>
                        </div>
                        <div class="modal-footer">
