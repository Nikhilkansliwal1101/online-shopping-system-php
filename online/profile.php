...
$query = "SELECT `name`, `mobile`, `address`, `city`, `state`, `pincode` FROM `customer` WHERE `email` LIKE '$email'";
    ...
    <fieldset disabled="disabled" id="form">
      <form class="row g-3" method="post" action="profile.php">
        <div class="col-12">
          ...
          <input type="email" class="form-control" id="inputEmail4" name="email" readonly value=<?php echo $_SESSION['logined']; ?>>
        </div>
        <div class="col-12">
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="address" required value=<?php echo "\"" . $detail['address'] . "\""; ?>>
        </div>
        <div class="col-md-4">
          <label for="inputZip" class="form-label">Pincode</label>
          <input type="number" class="form-control" id="inputZip" name="pincode" readonly value=<?php echo $detail['pincode']; ?>>
        </div>
        <div class="col-md-4">
          <label for="inputCity" class="form-label">City</label>
          <input type="text" class="form-control" id="inputCity" name="city" value="Jaipur" readonly required value=<?php echo $detail['city']; ?>>
        </div>
        <div class="col-md-4">
